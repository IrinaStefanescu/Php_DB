...
if(isset($_POST["id"])){
    $connection = new PDO("mysql:host=localhost".";dbname=spital","root", "");
        ...
        $stmt =  $connection->prepare("update  interventii set nr_doctori= '$nd'
                                        
                                         where  id_doctor = '".$id."' and id_operatie = '".$id2."'"); 
        $stmt->execute();
        
}
$query = "select * from interventii where id_doctor = '".$id."' and id_operatie = '".$id2."'";
 ...
 $connection = new PDO("mysql:host=localhost".";dbname=spital","root", "");
    ...
    header("Location:http://localhost/BDIrina/interventii.php");
}
...
<body>
    ...
    <div class="stage" style="overflow-y:auto;">
        ...
        <h2 style="text-align:center;width:100%;"> DEPARTAMENT </h2>
            <form action="editInterventie.php" method="post">
           <input type="hidden" name="id" value="<?php echo $results[0];?>">
           <input type="hidden" name="id2" value="<?php echo $results[1];?>">
           
           
            <div class="row">
                <label> Nr doctori </label>
                <input type="text" name="nr_doctori" value="<?php echo $results[2];?>" >
            </div>
