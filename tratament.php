...
$query = "select * from tratament";
if(isset($_GET["sort"])){
    if($_GET["sort"] == 1)
    $query = "select * from tratament order by tratament.nume_tratament asc";
    ...
    <div class="content">
            ...
            <h2 style="text-align:center;width:100%;"> TRATAMENT </h2>
                ...
                <select>
                         ...
                         <option  <?php if(isset($_GET["sort"]) && $_GET["sort"] == 1) echo 'selected="selected"'; ?> value="1">Sortare dupa nume tratament A-Z</option>
                </select>
            <table>
             ...
             <?php foreach($results as $linie){ ?>
                    <tr>
                        ...
                        <td>
                        <a href="/BDIrina/editTratament.php?id=<?php echo $linie[0];?>">Editeaza</a>
                        </td>

                        <td>
                            <a href="/BDIrina/stergereIntrare.php?tabel=tratament&cod_tratament=<?php echo $linie[0];?>">Sterge</a>
                        </td>
                    </tr>
            <?php } ?>    
