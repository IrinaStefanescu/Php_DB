...
$query = "select doctori.id_doctor,doctori.nume_doctor,doctori.prenume_doctor,doctori.telefon_doctor,departament.nume_departament from doctori join departament using(id_departament)";
if(isset($_GET["sort"])){
    if($_GET["sort"] == 1)
...
<body>
    ...
    <div class="stage" style="overflow-y:auto;">
        <div class="content">
            <h2 style="text-align:center;width:100%;"> DOCTORI </h2>
            <div class="select-wrapper">
                <select class="sort">
                         ...
                         <option <?php  if(isset($_GET["sort"]) && $_GET["sort"] == 2) echo 'selected="selected"'; ?> value="2">Sortare dupa nume Departament A-Z</option>
                </select>
            <table style="margin-top:20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/BDIrina/editDoctor.php?id=<?php echo $linie[0];?>">Editeaza</a>
                        </td>

                        <td>
                            <a href="/BDIrina/stergereIntrare.php?tabel=doctori&id_doctor=<?php echo $linie[0];?>">Sterge</a>
                        </td>
                    </tr>
            <?php } ?>    
