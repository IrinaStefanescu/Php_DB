...
if(isset($_POST["id"])){
    $connection = new PDO("mysql:host=localhost".";dbname=spital","root", "");
        ...
        $nd = $_POST["data_programare"];
        


        $stmt =  $connection->prepare("update  programari set data_programare = '$nd'
                                        
                                         where  id_doctor = '".$id."' and id_pacient = '".$id2."'"); 
        $stmt->execute();
        
}
$query = "select * from programari where id_doctor = '".$id."' and id_pacient = '".$id2."'";
 ...
 $connection = new PDO("mysql:host=localhost".";dbname=spital","root", "");
    ...
    header("Location:http://localhost/BDIrina/programari.php");
}
...
<body>
    ...
    <div class="stage" style="overflow-y:auto;">
        <div class="content">
        <h2 style="text-align:center;width:100%;"> PROGRAMARE </h2>
            <form action="editProgramare.php" method="post">
           <input type="hidden" name="id" value="<?php echo $results[0];?>">
           <input type="hidden" name="id2" value="<?php echo $results[1];?>">
           
            <div class="row">
                <label> Data </label>
                <input type="text" name="data_programare" value="<?php echo $results[2];?>">
            </div>
