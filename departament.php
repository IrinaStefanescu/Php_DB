<?php
 ...
 $query = "select * from departament";
    if($_GET["sort"] == 1)
    $query = "select * from departament order by departament.nume_departament asc";
    ...
    <h2 style="text-align:center;width:100%;"> DEPARTAMENT </h2>
            <div class="select-wrapper">
                <select>
                         ...
                         <option <?php if(isset($_GET["sort"]) && $_GET["sort"] == 1) echo 'selected="selected"'; ?> value="1">Sortare dupa nume Departament A-Z</option>
                </select>
            <table>
             ...
             <?php foreach($results as $linie){ ?>
                    <tr>
                        ...
                        <td>
                        <a href="/BDIrina/editDepartament.php?id=<?php echo $linie[0];?>">Editeaza</a>
                        </td>

                        <td>
                        <a href="/BDIrina/stergereIntrare.php?tabel=departament&id_departament=<?php echo $linie[0];?>">Sterge</a>
                        </td>
                    </tr>
            <?php } ?>    
...
$('select').on('change',function(ev){
    window.location.href="departament.php?sort="+this.value;
})
