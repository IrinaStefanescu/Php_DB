...
$spital = $spital[0];
 ...
 $query = "select * from operatii";
 if(isset($_GET["sort"])){
     if($_GET["sort"] == 1)
     $query = "select * from operatii order by id_operatie asc";
...
<body>
    ...
    <div class="content">
    <h2 style="text-align:center;width:100%;"> OPERATII </h2>
            <div class="select-wrapper">
                <select>
                   
                         <option value="0">Fara sortare</option>
                         <option <?php if(isset($_GET["sort"]) && $_GET["sort"] == 1) echo 'selected="selected"'; ?> value="1">Sortare dupa Id</option>
                </select>
            <table>
             ...
             <?php foreach($results as $linie){ ?>
                    <tr>
                        ...
                        <td>
                        <a href="/BDIrina/editOperatie.php?id=<?php echo $linie[0];?>">Editeaza</a>
                        </td>

                        <td>
                        <a href="/BDIrina/stergereIntrare.php?tabel=operatii&id_operatie=<?php echo $linie[0];?>">Sterge</a>
                        </td>
                    </tr>
            <?php } ?>    
